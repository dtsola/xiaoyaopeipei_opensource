...
import { mockDashboardStats, mockHotSKUs, mockLeads, delay } from '@/utils/mockData'
...
const stats = computed(() => [
  {
    key: 'consult',
    label: '咨询数',
    value: mockDashboardStats.consult_count,
    trend: mockDashboardStats.consult_trend,
    colorClass: '',
    icon: TeamOutlined
  },
  {
    key: 'leads',
    label: '线索数',
    value: mockDashboardStats.lead_count,
    trend: mockDashboardStats.lead_trend,
    colorClass: 'success',
    icon: UserOutlined
  },
  {
    ...
    trend: mockDashboardStats.conversion_trend,
    colorClass: 'warning',
...
const hotSKUs = computed(() => {
  ...
  return mockHotSKUs.map((sku, index) => ({
    ...sku,
