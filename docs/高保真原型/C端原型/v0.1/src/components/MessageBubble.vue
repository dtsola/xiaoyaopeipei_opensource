    ...
    <div class="message-wrapper">
      ...
      <div class="avatar-wrapper">
        <div class="avatar" :class="`avatar-${message.role}`">
          <svg v-if="message.role === 'assistant'" width="20" height="20" viewBox="0 0 20 20" fill="none">
            ...
            <path d="M10 18C8.5 18 7 17.5 6 16.5M10 18C11.5 18 13 17.5 14 16.5" stroke="var(--color-bg-primary)" stroke-width="1.5"/>
          </svg>
